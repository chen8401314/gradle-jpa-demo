...
public class JPADatabase extends H2Database {
    ...
    protected DSLContext create0() {
        if (connection == null) {
            ...
            try {
                ...
                info.put("user", "sa");
                info.put("password", "");
                //TODO below should be configurable in future
    ...
    private final void loadAttributeConverters(Collection<? extends Class<?>> classes) {
        ...
        } catch (NoClassDefFoundError e) {  // AttributeConverter is part of JPA 2.1. Older JPA providers may not have this type, yet
